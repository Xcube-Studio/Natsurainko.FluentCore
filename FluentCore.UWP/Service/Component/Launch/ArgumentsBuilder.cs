...
namespace FluentCore.UWP.Service.Component.Launch
{
    public class ArgumentsBuilder : IArgumentsBuilder
    {
        ...
        public string GetFrontArguments()
        {
            ...
            //stringBuilder.Replace("${path}", this.GameCore.Root.Contains(" ") ? $"\"{PathHelper.GetLogConfigsFolder(this.GameCore.Root)}\\{this.GameCore.Logging.Client.File.Id}\"" : $"{PathHelper.GetLogConfigsFolder(this.GameCore.Root)}\\{this.GameCore.Logging.Client.File.Id}");
        ...
        public string GetBehindArguments()
        {
            ...
            //Legacy Minecraft
            stringBuilder.Replace("${game_assets}", assetsPath.Contains(" ") ? $"\"{assetsPath}\\virtual\\legacy\"" : $"{assetsPath}\\virtual\\legacy");
        ...
        public string GetClasspath()
        {
            ...
            foreach (var library in this.GameCore.Libraries)
                stringbuilder.Append($"{PathHelper.GetLibrariesFolder(this.GameCore.Root)}\\{library.GetRelativePath()};");
