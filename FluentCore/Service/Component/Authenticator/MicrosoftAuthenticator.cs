...
namespace FluentCore.Service.Component.Authenticator
{
    public class MicrosoftAuthenticator : IAuthenticator
    {
        ...
        public async Task<Tuple<BaseResponseModel, AuthResponseType>> AuthenticateAsync()
        {
            ...
            var authenticateMinecraftRes = JObject.Parse(await authenticateMinecraftPostRes.Content.ReadAsStringAsync());
            ...
            var authorization = new Tuple<string, string>("Bearer", (string)authenticateMinecraftRes["access_token"]);
