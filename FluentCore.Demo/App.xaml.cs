using FluentCore.Demo.Converters;
using System;
...
namespace FluentCore.Demo
{
    ...
    sealed partial class App : Application
    {
        ...
        private void BeforeInitializeDo()
        {
            Windows.UI.ViewManagement.ApplicationView.PreferredLaunchViewSize = new Size(1140, 600);
            Windows.UI.ViewManagement.ApplicationView.PreferredLaunchWindowingMode = Windows.UI.ViewManagement.ApplicationViewWindowingMode.PreferredLaunchViewSize;
        }

        public void AfterOnLaunchedDo()
        {
